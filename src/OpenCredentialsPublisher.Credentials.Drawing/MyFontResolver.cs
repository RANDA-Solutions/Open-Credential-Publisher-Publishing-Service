...
namespace OpenCredentialsPublisher.Credentials.Drawing
{
    class MyFontResolver : IFontResolver
    {
        ...
        public byte[] GetFont(string faceName)
        {
            ...
            {
                case "Verdana#":
                    return LoadFontData("OpenCredentialsPublisher.Credentials.Drawing.Fonts.Verdana.verdana.ttf"); ;

                case "Verdana#b":
                    return LoadFontData("OpenCredentialsPublisher.Credentials.Drawing.Fonts.Verdana.verdanab.ttf"); ;

                case "Verdana#i":
                    return LoadFontData("OpenCredentialsPublisher.Credentials.Drawing.Fonts.Verdana.verdanai.ttf");

                case "Verdana#bi":
                    return LoadFontData("OpenCredentialsPublisher.Credentials.Drawing.Fonts.Verdana.verdanaz.ttf");
            }
